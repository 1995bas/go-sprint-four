...
/*
func main() {
	// Вы можете добавить здесь код для вызова ваших функций и вывода результатов на экран.
	fmt.Println("Программа для отслеживания тренировок")
	// Пример вызова функции ShowTrainingInfo:
	// info := ShowTrainingInfo(1000, "Бег", 1.5, 70, 180, 25, 5)
	info := ShowTrainingInfo(1000, "Бег", 1.5, 70.0, 18.9, 25, 5)
